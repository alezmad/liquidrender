/**
 * Full Onboarding Pipeline Test with Pagila (DVD Rental)
 *
 * Deletes existing Pagila data and runs complete onboarding:
...
// Pagila via LiquidGym PostgreSQL (port 5433)
// DVD Rental database - good for subscription/rental KPIs
const DB_CONNECTION = "postgresql://superadmin:superadmin@localhost:5433/pagila";
const DB_SCHEMA = "public";
const DB_NAME = "Pagila";
const BUSINESS_TYPE = "subscription"; // DVD rental is subscription-like
