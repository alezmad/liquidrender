...
export const QUESTION_TYPE_DESCRIPTIONS: Record<QuestionType, string> = {
  ...
  textarea: 'Allow respondents to enter multi-line text',
  ...
  ranking: 'Drag and drop items to rank in order of preference',
  hidden: 'Store data without displaying to respondent',
  password: 'Masked input for sensitive data',
  captcha: 'Verify respondent is human',
  audio: 'Record audio responses',
  video: 'Record video responses',
  address: 'Collect structured address information',
} as const;
